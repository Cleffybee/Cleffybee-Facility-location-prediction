# -*- coding: utf-8 -*-
"""
Created on Sat Jul 17 18:08:55 2021
...
st.write("The data")
df= pd.read_csv('https://raw.githubusercontent.com/Cleffybee/Cleffybee-Facility-location-prediction/main/Target.csv',encoding='latin-1')
st.write(df.head())
#df.head()
